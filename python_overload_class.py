...
class type(object):
    ...
    def __init__(self, name: str,
                 bases: Tuple[type, ...], dict: Dict[str, Any]) -> None: ...

    @overload
    def __new__(cls, o: object) -> type: ...
    @overload
    def __new__(cls, name: str,
                bases: Tuple[type, ...], namespace: Dict[str, Any]) -> type: ...
    ...
    def __prepare__(metacls, __name: str,
                    __bases: Tuple[type, ...], **kwds: Any) -> Mapping[str, Any]: ...
...
class int:
    @overload
    def __new__(cls: Type[_T], x: Union[str, bytes, SupportsInt,
                                        _SupportsIndex, _SupportsTrunc] = ...) -> _T: ...
...
class float:
    def __new__(cls: Type[_T], x: Union[SupportsFloat,
                                        _SupportsIndex, str, bytes, bytearray] = ...) -> _T: ...
...
class complex:
    ...
    @overload
    def __new__(cls: Type[_T], real: Union[str,
                                           SupportsComplex, _SupportsIndex]) -> _T: ...
...
class str(Sequence[str]):
    ...
    def title(self) -> str: ...
    def translate(self, __table: Union[Mapping[int, Union[int,
                                                          str, None]], Sequence[Union[int, str, None]]]) -> str: ...

    def upper(self) -> str: ...
    def zfill(self, __width: int) -> str: ...
    @staticmethod
    @overload
    def maketrans(__x: Union[Dict[int, _T], Dict[str, _T],
                             Dict[Union[str, int], _T]]) -> Dict[int, _T]: ...

    @staticmethod
    @overload
    def maketrans(__x: str, __y: str,
                  __z: Optional[str] = ...) -> Dict[int, Union[int, None]]: ...
...
class bytes(ByteString):
    ...
    def count(self, sub: Union[bytes, int], start: Optional[int]
              = ..., end: Optional[int] = ...) -> int: ...

    def decode(self, encoding: str = ..., errors: str = ...) -> str: ...
    def endswith(self, suffix: Union[bytes, Tuple[bytes, ...]]) -> bool: ...
    def expandtabs(self, tabsize: int = ...) -> bytes: ...
    def find(self, sub: Union[bytes, int], start: Optional[int]
             = ..., end: Optional[int] = ...) -> int: ...
    if sys.version_info >= (3, 8):
        def hex(self, sep: Union[str, bytes] = ...,
                bytes_per_sep: int = ...) -> str: ...
    else:
        def hex(self) -> str: ...

    def index(self, sub: Union[bytes, int], start: Optional[int]
              = ..., end: Optional[int] = ...) -> int: ...
    ...
    def isupper(self) -> bool: ...
    def join(
        self, __iterable_of_bytes: Iterable[Union[ByteString, memoryview]]) -> bytes: ...
    ...
    def rfind(self, sub: Union[bytes, int], start: Optional[int]
              = ..., end: Optional[int] = ...) -> int: ...
    def rindex(self, sub: Union[bytes, int], start: Optional[int]
               = ..., end: Optional[int] = ...) -> int: ...

    def rjust(self, __width: int, __fillchar: bytes = ...) -> bytes: ...
    def rpartition(self, __sep: bytes) -> Tuple[bytes, bytes, bytes]: ...
    def rsplit(self, sep: Optional[bytes] = ...,
    ...
    def translate(self, __table: Optional[bytes],
                  delete: bytes = ...) -> bytes: ...
...
class bytearray(MutableSequence[int], ByteString):
    ...
    def count(self, __sub: Union[bytes, int], __start: Optional[int]
              = ..., __end: Optional[int] = ...) -> int: ...
    ...
    def find(self, __sub: Union[bytes, int], __start: Optional[int]
             = ..., __end: Optional[int] = ...) -> int: ...

    def hex(self) -> str: ...
    def index(self, __sub: Union[bytes, int], __start: Optional[int]
              = ..., __end: Optional[int] = ...) -> int: ...
    ...
    def isupper(self) -> bool: ...
    def join(
        self, __iterable_of_bytes: Iterable[Union[ByteString, memoryview]]) -> bytearray: ...

    def ljust(self, __width: int, __fillchar: bytes = ...) -> bytearray: ...
    def lower(self) -> bytearray: ...
    def lstrip(self, __bytes: Optional[bytes] = ...) -> bytearray: ...
    def partition(self, __sep: bytes) -> Tuple[bytearray,
                                               bytearray, bytearray]: ...
    if sys.version_info >= (3, 9):
    ...
    def replace(self, __old: bytes, __new: bytes,
                __count: int = ...) -> bytearray: ...
    def rfind(self, __sub: Union[bytes, int], __start: Optional[int]
              = ..., __end: Optional[int] = ...) -> int: ...
    def rindex(self, __sub: Union[bytes, int], __start: Optional[int]
               = ..., __end: Optional[int] = ...) -> int: ...

    def rjust(self, __width: int, __fillchar: bytes = ...) -> bytearray: ...
    def rpartition(self, __sep: bytes) -> Tuple[bytearray,
                                                bytearray, bytearray]: ...
    def rsplit(self, sep: Optional[bytes] = ...,
               maxsplit: int = ...) -> List[bytearray]: ...
...
class memoryview(Sized, Container[int]):
    ...
    def cast(self, format: str,
             shape: Union[List[int], Tuple[int]] = ...) -> memoryview: ...
    ...
    if sys.version_info >= (3, 8):
        def tobytes(
            self, order: Optional[Literal["C", "F", "A"]] = ...) -> bytes: ...
    else:
...
class list(MutableSequence[_T], Generic[_T]):
    ...
    @overload
    def sort(
        self, *, key: Callable[[_T], SupportsLessThan], reverse: bool = ...) -> None: ...
...
class dict(MutableMapping[_KT, _VT], Generic[_KT, _VT]):
    ...
    @overload
    def __init__(
        self, map: SupportsKeysAndGetItem[_KT, _VT], **kwargs: _VT) -> None: ...
...
def filter(__function: None,
           __iterable: Iterable[Optional[_T]]) -> Iterator[_T]: ...
...
def isinstance(
    __obj: object, __class_or_tuple: Union[type, Tuple[Union[type, Tuple[Any, ...]], ...]]) -> bool: ...


def issubclass(
    __cls: type, __class_or_tuple: Union[type, Tuple[Union[type, Tuple[Any, ...]], ...]]) -> bool: ...
...
def map(__func: Callable[[_T1], _S],
        __iter1: Iterable[_T1]) -> Iterator[_S]: ...
...
@overload
def max(__iterable: Iterable[SupportsLessThanT],
        *, key: None = ...) -> SupportsLessThanT: ...
...
@overload
def max(__iterable: Iterable[SupportsLessThanT], *, key: None = ...,
        default: _T) -> Union[SupportsLessThanT, _T]: ...


@overload
def max(__iterable: Iterable[_T1], *, key: Callable[[_T1],
                                                    SupportsLessThanT], default: _T2) -> Union[_T1, _T2]: ...
...
@overload
def min(__iterable: Iterable[SupportsLessThanT],
        *, key: None = ...) -> SupportsLessThanT: ...
...
@overload
def min(__iterable: Iterable[SupportsLessThanT], *, key: None = ...,
        default: _T) -> Union[SupportsLessThanT, _T]: ...
...
if sys.version_info >= (3, 8):
    ...
    def pow(base: int, exp: int,
            mod: None = ...) -> Any: ...  # returns int or float depending on whether exp is non-negative
...
@overload
def sorted(__iterable: Iterable[SupportsLessThanT], *, key: None = ...,
           reverse: bool = ...) -> List[SupportsLessThanT]: ...


@overload
def sorted(__iterable: Iterable[_T], *, key: Callable[[_T],
                                                      SupportsLessThan], reverse: bool = ...) -> List[_T]: ...
